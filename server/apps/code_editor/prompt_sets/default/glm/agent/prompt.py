...
Example — writing a file with multiple parameters (nothing to compress yet):
<tool_call>write_file<arg_key>file_path</arg_key><arg_value>src/App.vue</arg_value><arg_key>contents</arg_key><arg_value>export default { name: 'App' }</arg_value><arg_key>_context_updates</arg_key><arg_value>[]</arg_value></tool_call>
